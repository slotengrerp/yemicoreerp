...
export default function Accounting({data,setData}){
  ...
  useEffect(() => {
    ...
    setJournals(js => {
      ...
      // ── Petty Cash (Approved vouchers only — Pending/Rejected never moved
      // real cash, so they never touch the GL) ─────────────────────────────
      ...
      // ── Fixed Assets (capitalization entry only — see journalFromFixedAsset
      // for why depreciation posting isn't included here) ─────────────────
