    ...
    <div style={{ display:'flex', flexDirection:'column', gap:16 }}>
      ...
      <div style={{ background:C.bgCard, border:'1px solid '+C.border, borderRadius:12, boxShadow:C.shadowCard }}>
        ...
        <div style={{ padding:'0 20px 20px', overflowX:'auto' }}>
          ...
          {view==='payroll' && (
            <>
              <div style={{ display:'flex', alignItems:'center', gap:10, marginBottom:12, padding:'8px 14px', background:C.greenPale, border:'1px solid '+C.greenLight, borderLeft:'4px solid '+C.green, borderRadius:8 }}>
